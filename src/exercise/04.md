...
Basically usefull to create common use cases for hooks/components? Yes, and then you can simply spread them in other components too, makes it easier. Interesting idea. But only for default cases.
Learned (more like remembered) about curried functions. Very nice.
