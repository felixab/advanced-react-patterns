...
## 📝 Your Notes
The goal is essentially components refactoring. This is a usefull pattern for this.
Use child components as logic, handle state with englobing component, a bit like HOC pattern (without the props).
Mostly used for libraries and super black boxes
